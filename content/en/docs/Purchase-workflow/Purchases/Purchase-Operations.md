...
| `Currency` | `string` | Yes | Currency of the purchase, according to ISO-4217. Find the possible values in the Currencies table of [each country](/docs/payment-methods.html). |
...
| `Customer` → `DocumentTypeId` | `string` | No | Customer document type. Find the possible values in the Document types table of [each country](/docs/payment-methods.html). |

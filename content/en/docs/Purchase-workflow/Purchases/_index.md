...
Depending on the contract you have signed with _Bamboo Payment_ ([Gateway](/docs/getting-started/concepts.html#gateway-model) or [Payfac](/docs/getting-started/concepts.html#payfac-model) model) and the countries where you process, you can create Local or CrossBorder purchases.

...
***Important:*** The `firstName` and `lastName` fields do not support numbers or special characters, only letters. The `companyName` field does accept all types of alphanumeric characters._

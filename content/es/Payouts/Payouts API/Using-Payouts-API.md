...
<sup>1</sup> _Sólo aplica para Brasil (PIX) o Colombia (Breb) usando `type` Pago instantáneo. En caso contrario, el objeto `payee.InstantPaymentData` y sus parámetros no deben estar presentes en el request._<br>

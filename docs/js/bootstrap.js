...
(function($){
	$(document).ready(function(){
        ...
        (function temporal() {
            ...
            } else if(pathname.indexOf("/sobre-bamboo-latam") > -1){
                //menuItems.removeClass("active").filter('[href="/sobre-bamboo-latam"]').addClass("active");
				menuItems.filter(function(){return $(this).attr("href").match(/^\/[a-z]+\/sobre-bamboo-latam$/);}).addClass("active");
            } else {
            }
        })();


        $('#bamboo-main-slider').flexslider({
            animation: "slide",
            animationLoop: true,
            directionNav: false,
            controlNav: false
        ...
        $('#bamboo-clients-carousel').flexslider({
            animation: "slide",
            animationLoop: false,
            directionNav: true,
            controlNav: false,
        ...
        if ($(".bamboo-page-header").length > 0){
            // Cache selectors
            var lastId,
                topMenu = $('.bamboo-page-header'),
